...
**(a)** The number 48730 rounded to *two significant figures* is: `r fitb(4900)`
...
**(b)** $\dfrac{\left(2x^3\right)^5}{8x^9}$ can be written in the form $ax^b$. The value of $a$ is: `r fitb(8)` and the value of $b$ is: `r fitb(6)`.
